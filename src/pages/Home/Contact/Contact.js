...
const Contact = () => {
    return (
        <div>
            <div>
                <div className="hero rounded-lg mt-24"
                    style={{
                        background: `url(${bg})`,
                ...
                >
                    <div className="card  w-full max-w-sm ">
                        <div className="card-body">
                            ...
                            <h1 className='text-3xl font-semibold text-center mb-2'>Stay connected with us</h1>
                            ...
                            <div className=" text-center mt-3">
                                <button className="btn btn-primary text-white w-32">SUBMIT</button>
                            </div>
                        </div>
                    </div>
                </div>
